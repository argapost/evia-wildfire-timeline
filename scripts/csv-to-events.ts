...
const CATEGORY_MAP: Record<string, string> = {
  ...
  'forestry service works': 'forestry-works',
  'works by the forestry service': 'forestry-works',
  'spatial planning phases': 'spatial-planning',
  'spatial planning': 'spatial-planning',
  'elections': 'election',
  'election': 'election',
  'announcements-events-meetings-works by diazoma': 'reconstruction-governance',
  "announcements-events-meetings-works by 'diazoma'": 'reconstruction-governance',
  'political event': 'state-agency-action',
